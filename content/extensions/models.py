...
from django.db.models import SmallIntegerField, SlugField, PositiveIntegerField
...
__all__ = [
    'Model', 'IntegerChoices', 'TextChoices', 'DecimalField', 'TextField',
    ...
    'SmallIntegerField', 'SlugField', 'PositiveIntegerField'
]
