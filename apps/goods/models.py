...
class GoodsCategory1(Model):
    """产品一级分类"""

    name = CharField(max_length=64, verbose_name='一级分类')
    name_id = CharField(max_length=64, verbose_name='一级分类ID')
    remark = CharField(max_length=256, null=True, blank=True, verbose_name='备注')

    class Meta:
        unique_together = [('name', 'name_id')]

class GoodsCategory2(Model):
    """产品一级分类"""

    name = CharField(max_length=64, verbose_name='二级分类')
    name_id = CharField(max_length=64, verbose_name='二级分类ID')
    remark = CharField(max_length=256, null=True, blank=True, verbose_name='备注')
    category = ForeignKey('goods.GoodsCategory1', on_delete=SET_NULL, null=True,
                        related_name='goods_set', verbose_name='产品一级分类')

    class Meta:
        unique_together = [('name', 'name_id')]


class GoodsCategory3(Model):
    """产品三级分类"""

    name = CharField(max_length=64, verbose_name='三级分类')
    name_id = CharField(max_length=64, verbose_name='三级分类ID')
    remark = CharField(max_length=256, null=True, blank=True, verbose_name='备注')
    category = ForeignKey('goods.GoodsCategory2', on_delete=SET_NULL, null=True,
                          related_name='goods_set', verbose_name='产品二级分类')

    class Meta:
        unique_together = [('name', 'name_id')]


class GoodsCategory4(Model):
    """产品四级分类"""

    name = CharField(max_length=64, verbose_name='四级分类')
    name_id = CharField(max_length=64, verbose_name='四级分类ID')
    remark = CharField(max_length=256, null=True, blank=True, verbose_name='备注')
    category = ForeignKey('goods.GoodsCategory3', on_delete=SET_NULL, null=True,
                          related_name='goods_set', verbose_name='产品三级分类')
...
class Goods(Model):
    ...
    category4 = ForeignKey('goods.GoodsCategory4', on_delete=SET_NULL, null=True,
                          related_name='goods_set', verbose_name='产品四级分类')
    category3 = ForeignKey('goods.GoodsCategory3', on_delete=SET_NULL, null=True,
                        related_name='goods_set', verbose_name='产品四级分类')
    category2 = ForeignKey('goods.GoodsCategory2', on_delete=SET_NULL, null=True,
                        related_name='goods_set', verbose_name='产品四级分类')
    category1 = ForeignKey('goods.GoodsCategory1', on_delete=SET_NULL, null=True,
                        related_name='goods_set', verbose_name='产品四级分类')
#   category = ForeignKey(to="ItemType", to_field="product",  null=True, blank=True, on_delete=SET_NULL)
