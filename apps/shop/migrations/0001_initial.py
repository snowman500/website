    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_sku', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='shopspu_itemsku', to='item.itemsku')),
            ],
            options={
                'verbose_name': '商品SKU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('fa_star', models.IntegerField(default=0, verbose_name='评论星星')),
