    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fa_star', models.DecimalField(decimal_places=1, max_digits=2, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(5.0)], verbose_name='评论星星')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pcb_material', models.CharField(blank=True, max_length=8, null=True, verbose_name='PCB类型')),
                ('pcb_t', models.DecimalField(blank=True, decimal_places=2, max_digits=3, null=True, verbose_name='PCB厚度')),
                ('a_pcb_num', models.DecimalField(blank=True, decimal_places=0, max_digits=2, null=True, verbose_name='一套几条A板')),
                ('b_pcb_num', models.DecimalField(blank=True, decimal_places=0, max_digits=2, null=True, verbose_name='一套几条B板')),
                ('c_pcb_num', models.DecimalField(blank=True, decimal_places=0, max_digits=2, null=True, verbose_name='一套几条C板')),
                ('d_pcb_num', models.DecimalField(blank=True, decimal_places=0, max_digits=2, null=True, verbose_name='一套几条D板')),
                ('a_pcb_l', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='A板PCB长度')),
                ('a_pcb_w', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, verbose_name='A板PCB宽度')),
                ('b_pcb_l', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='B板PCB长度')),
                ('b_pcb_w', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, verbose_name='B板PCB宽度')),
                ('c_pcb_l', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='C板PCB长度')),
                ('c_pcb_w', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, verbose_name='C板PCB宽度')),
                ('d_pcb_l', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='D板PCB长度')),
                ('d_pcb_w', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, verbose_name='D板PCB宽度')),
                ('led_num', models.CharField(max_length=8, verbose_name='LED灯珠数量')),
                ('led_power', models.CharField(max_length=8, verbose_name='LED灯珠功率')),
                ('lens', models.CharField(max_length=8, verbose_name='透镜类型')),
                ('a_cnt', models.CharField(max_length=8, verbose_name='透镜类型')),
                ('b_cnt', models.CharField(max_length=8, verbose_name='透镜类型')),
                ('c_cnt', models.CharField(max_length=8, verbose_name='透镜类型')),
                ('d_cnt', models.CharField(max_length=8, verbose_name='透镜类型')),
                ...
                ('image1', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='主图')),
                ('image2', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image3', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image4', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image5', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image6', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image7', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image8', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image9', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
                ('image10', models.ImageField(blank=True, null=True, upload_to='goods_name', verbose_name='辅图')),
