...
class WarehouseInfoAdmin(admin.ModelAdmin):
    list_display = (
    'id', 'warehouse_code', 'warehouse_name', 'link_man', 'phone_number', 'province', 'city', 'distrct', 'address')
...
class SupplierAdmin(admin.ModelAdmin):
    list_display = (
    'id', 'supplier_code', 'supplier_name', 'link_man', 'phone_number', 'bank_name', 'bank_account', 'address')
...
class ItemSpecificationAdmin(admin.ModelAdmin):
    list_display = (
    'id', 'name', 'name_id', 'spec_0', 'spec_1', 'spec_2', 'spec_3', 'spec_4', 'spec_5', 'spec_6', 'spec_7', 'spec_8',
    'spec_9', 'remark')


class ItemSKUAdmin(admin.ModelAdmin):
    list_display = (
    'id', 'spec', 'goods', 'item_id', 'name', 'desc', 'price', 'unite', 'current_cnt', 'sales', 'supplier')
